...
/// </summary>
[ExecuteInEditMode]
public class CloneCameraRig : MonoBehaviour
{
	/// <summary>
	/// The left eye camera.
	/// </summary>
    ...
    public Transform left_Parent { get; private set; }
    public Transform right_Parent { get; private set; }
	...
	/// </summary>
	public event System.Action<CloneCameraRig> UpdatedAnchors;
	/// <summary>
    ...
    protected readonly string left_parent_name = "LeftParent";
    protected readonly string right_parent_name = "RightParent";
...
#region Unity Messages
	...
	public virtual void EnsureGameObjectIntegrity()
	{
        ...
        //Selfdefined;
        if (left_Parent == null)
            left_Parent = ConfigureAnchor(trackingSpace, left_parent_name);
        if (right_Parent == null)
            right_Parent = ConfigureAnchor(trackingSpace, right_parent_name);

        if (leftEyeAnchor == null)
			leftEyeAnchor = ConfigureAnchor(left_Parent, leftEyeAnchorName);

		if (centerEyeAnchor == null)
			centerEyeAnchor = ConfigureAnchor(trackingSpace, centerEyeAnchorName);

		if (rightEyeAnchor == null)
			rightEyeAnchor = ConfigureAnchor(right_Parent, rightEyeAnchorName);
