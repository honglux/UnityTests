...
public class Player2 : MonoBehaviour {
    ...
    private void push_to_pos(Vector3 pos)
    {
        ...
        player_RB.MovePosition(transform.position + directrion * Speed * Time.deltaTime);
    }
    ...
    private void move_to_next(Vector3 pos)
    {
        Vector3 directrion = (pos - transform.position).normalized;
        //transform.Translate(pos * Speed * Time.deltaTime);
        transform.Translate(directrion * Speed * Time.deltaTime);
    }
}
