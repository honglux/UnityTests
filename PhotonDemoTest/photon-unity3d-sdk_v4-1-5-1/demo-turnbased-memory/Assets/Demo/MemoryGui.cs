...
public class MemoryGui : MonoBehaviour
{
    ...
    public void OnEnable()
    {
        ...
        this.GameClientInstance.StateChanged += this.OnStateChanged;
    ...
    public void Update()
    {
        ...
        {
            Debug.Log("SwitchToGame. InStateTransition:" + this.MainMenuRoot.InStateTransition+ " GameIsLoaded:" + this.GameClientInstance.GameIsLoaded);
    ...
    private void UpdateInGameTexts()
    {
        ...
        //{
        //    Text pointsGuiText = this.InGameScoresText.GetComponent<Text>();
        ...
        //    else
        //    {
        //        Debug.Log("111 " + this.GameClientInstance.MyPoints.ToString());
        //        Debug.Log("222 " + this.GameClientInstance.OthersPoints.ToString());
        //        Debug.Log("333 " + other.NickName.ToString());
        ...
        //    txt.GetComponent<Text>().text = theText;
        //}
    }
    ...
    {
        //this.InGameInfoText.GetComponent<Text>().enabled = false;
    ...
    public void NewGameMsg()
    {
        ...
        this.GameClientInstance.OpJoinRandomRoom();
    }
